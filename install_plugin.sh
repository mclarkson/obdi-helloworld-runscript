...
t="/tmp/install_helloworld_runscript_$$"
touch $t
[[ $? -ne 0 ]] && {
...
curl -k -d '{
    "Code":"HELLOWORLD_RUNSCRIPT_WORKER",
    "Desc":"Location of the worker helloworld-runscript will use.",
    "IsWorkerDef":true
...
curl -k -d '{
    "Name":"helloworld-runscript.js",
    "Desc":"Controller for HelloWorld Runscript.",
    "Type":1,
    "PluginId":'"$id"',
    "Url":"helloworld-runscript/js/controllers/helloworld-runscript.js"
...
script="helloworldrunscript-show.sh"
